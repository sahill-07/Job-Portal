    ...
    return (
        <div className="bg-gray-50 dark:bg-gray-900 min-h-screen">
            ...
            <div className='flex items-center justify-center w-screen my-5'>
                <form onSubmit={submitHandler} className='p-8 max-w-4xl w-full border border-gray-200 shadow-lg rounded-md bg-white dark:bg-gray-800'>
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                        ...
                        {
                            companies.length > 0 && (
                                <Select onValueChange={selectChangeHandler} className="col-span-1 md:col-span-2">
